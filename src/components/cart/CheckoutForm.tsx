...
import { ArrowLeft, CreditCard, Smartphone, Phone, MapPin, User, CheckCircle, AlertCircle, QrCode } from 'lucide-react';
...
export function CheckoutForm({ onSuccess, onBack }: CheckoutFormProps) {
  ...
  const translations = {
    ...
    fr: {
      ...
      qrCodeTitle: 'Code QR de la Commande',
    }
  };
            ...
            {currentStep === 'success' && (
              <div className="bg-white rounded-lg shadow-md p-8 text-center">
                ...
                <div className="flex space-x-4">
                  ...
                  <Button onClick={handleSuccessComplete} variant="primary" className="flex-1">
                    Continue Shopping
                  </Button>
                </div>
              </div>
